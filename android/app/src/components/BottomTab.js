...
import {HomeActive, HomeDefault, TransaksiActive, TransaksiDefault, UserActive, UserDefault} from '../assets';
      ...
      {state.routes.map((route, index) => {
        ...
        return (
          <TouchableOpacity
            ...
            <Text style={{color: isFocused ? BLUE_COLOR : LIGHT_COLOR}}>{label}</Text>
          </TouchableOpacity>
        );
      })}
    </View>
